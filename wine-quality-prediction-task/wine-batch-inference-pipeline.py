...
print("Wine quality predicted: ", int(wine))
...
print("Wine quality actual: ", int(label))
...
print(
    "Number of different wine quality predictions to date: ",
    int(predictions.value_counts().count()),
)
if predictions.value_counts().count() == 3:
    ...
    dataset_api.upload(
        "./confusion_wine_matrix.png", "Resources/images", overwrite=True
    )
else:
    print("You need 3 different quality predictions to create the confusion matrix.")
    print(
        "Run the batch inference pipeline more times until you get 3 different quality wines"
    )
